  ...
  try {
    ...
    try {
      await sendMail({
        ...
        html: `<b>Спасибо за регистрацию!</b><br>
      Пожалуйста, подтвердите свой e-mail для активации аккаунта:<br>
      <a href="${link}">${link}</a>
      <br><br>Если вы не регистрировались — просто проигнорируйте это письмо.<br><br>
      С уважением, команда EUROPAY.`
      });
